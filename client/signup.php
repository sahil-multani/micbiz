                  ...
                  <div class="sign-user_card ">
                     <div class="d-flex justify-content-center">
                        <div class="sign-user_logo">
                           <img class="profile-pic img-fluid" src="/music/src/images/user/11.png" alt="profile-pic">
                        </div>
                     </div>
                     <div class="sign-in-page-data">
                        <div class="sign-in-from w-100 m-auto pt-5">
                           ...
                           <form
		                           class="needs-validation mt-4" novalidate method="POST" name="addUser"
                              ...
                              <div class="form-group">
                                 ...
                                 <input
		                                 type="email" class="form-control mb-0" id="exampleInputEmail3"
