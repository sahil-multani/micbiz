    ...
    if (response.status !== 200) {
      ...
      response.json().then(function (data) {
        for (let i = 0; i < data.length; i++) {
          ...
          let markup = `<li class="col-xl-2 col-lg-3 col-md-4 iq-music-box play" onclick='getmusic(${i})'>
...
function getmusic(no) {
  //let src = arr[no] + "?client_id=8538a1744a7fdaa59981232897501e04";
