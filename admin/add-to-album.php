					...
					<div class="col-sm-12 ">
						<div class="iq-card">
							...
							<div class="iq-card-body">
								<p>add songs to album</p>
								<form method='post'>
									<div class="form-group">
										<label for="playlists"> select a album :</label>
										<select class="form-control" required="" id="playlists" name="pl">
										</select>
									</div>
									<div class="form-group">
...
<script>
	...
	function getPlaylists() {
		$.ajax({
			type: 'POST',
			url: '/music/assets/add/album.php',
			data: 0,
