<script >
  ...
  function playPause() {
	setTimeout(function () {
	  if (audio.paused) {
		...
		checkBuffering();
		$("#play-pause-button").find("i").attr("class", "fa fa-pause-circle fa-3x");
		audio.play();
	  } else {
		...
		$("#play-pause-button").find("i").attr("class", "fa fa-play-circle fa-3x");
		audio.pause();
	  }
	}, 300);
  }
  ...
  function selectTrack(flag) {
	...
	if (currIndex > -1 && currIndex < albumArtworks.length) {
	  if (flag == 0) $("#play-pause-button").find("i").attr("class", "fa fa-play-circle fa-3x");
	  else {
		albumArt.removeClass("buffering");
			...
			let markup = `<li class="col-xl-2 col-lg-3 col-md-4 iq-music-box play" >
                                                <div class="iq-card" >
                                                    <div class="iq-card-body p-0">
                                                        <div class="iq-thumb" onclick="getmusic(${i})">
  ...
  // like dislike add to playlist sytstem //---##################################################################
  $(document).on("click", ".like", function () {
	let url = '/music/assets/add/like.php';
