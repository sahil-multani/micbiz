            ...
            <ul id="iq-sidebar-toggle" class="iq-menu">
                <li class="active active-menu">
                    <a href="#dashboard" class="iq-waves-effect" data-toggle="collapse" aria-expanded="true"><span
                                class="ripple rippleEffect"></span><i class="las la-home iq-arrow-left"></i><span>Dashboard</span><i
                ...
                <li>
                    <a href="#lib" class="iq-waves-effect" data-toggle="collapse" aria-expanded="false"><span
                                class="ripple rippleEffect"></span><i class="lab la-elementor iq-arrow-left"></i><span>Library</span><i
                                class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                    <ul id="lib" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li><a href="admin-category.html"><i class=" las la-heart"></i>liked songs</a></li>
                        <li><a href="admin-dashboard.html"><i class="ri-function-line"></i>Recents</a></li>
                        <li><a href="admin-writer.html"><i class="las la-music"></i>plalists</a></li>
